...
import { UserCircleIcon, ChevronDownIcon, PhotoIcon } from "@heroicons/react/24/solid";

const Footer = () => {
   return (
      <>
         <form className="bg-gray-950">
            <div className="max-w-[1200px] m-auto space-y-12 ">
                        ...
                        <div className="mt-2 flex justify-center rounded-lg border border-dashed border-white/25 px-6 py-10">
                           <div className="text-center">
                              ...
                              <div className="mt-4 flex text-sm/6 text-gray-400">
                                 ...
                                 <p className="pl-1">Bunga ozingiz xohlagan rasm qoyaverasiz</p>
                              </div>
                           </div>
                        </div>
                     </div>
